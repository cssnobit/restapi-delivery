...
insert into estado (id, nome) values (3, 'Maranhão');

insert into cidade (id, nome, estado_id) values (1, 'Santos', 2);
insert into cidade (id, nome, estado_id) values (2, 'Belo Horizonte', 1);
insert into cidade (id, nome, estado_id) values (3, 'São Paulo', 2);
insert into cidade (id, nome, estado_id) values (4, 'São Vicente', 2);
insert into cidade (id, nome, estado_id) values (5, 'São Luís', 3);
